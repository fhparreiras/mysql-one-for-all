...
CREATE TABLE SpotifyClone.artistaSeguidores(
    seguidor_id INT,
    artista_seguido_id INT,
    CONSTRAINT PRIMARY KEY (seguidor_id, artista_seguido_id),
    CONSTRAINT FOREIGN KEY (seguidor_id) REFERENCES usuarios (id_usuario),
    CONSTRAINT FOREIGN KEY (artista_seguido_id) REFERENCES artistas (id_artista)
) engine = InnoDB;
...
CREATE TABLE SpotifyClone.historico(
    ...
    CONSTRAINT FOREIGN KEY (musica_id) REFERENCES musicas (id_musica)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.albuns (id_album, nome, artista_id, ano_lancamento)
VALUES
	(1, 'Envious', 1, '1990'),
	(2, 'Exuberant', 1, '1993'),
...
INSERT INTO SpotifyClone.musicas (id_musica, nome, duracao_segundos, album_id)
VALUES  
	(1, 'Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.usuarios (id_usuario, nome, idade, plano_id, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.artistaSeguidores (seguidor_id, artista_seguido_id)
VALUES
	(1, 1),
	(1, 4),
	(1, 3),
